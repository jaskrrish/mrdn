...
export default function Intelligence() {
  ...
  const insights = [
    { id: 1, title: 'Border Telemetry Alert', date: '2024.11.20', category: 'DEFENSE', content: 'Helix ingested 43 anomalous drone telemetry signals converging along the western grid in a 4-minute window. Orion correlated this with encrypted VHF chatter flagged by Aegis. Threat score pushed to 92. Border units notified.' },
    { id: 2, title: 'Commodity Import Anomaly', date: '2024.11.19', category: 'ENTERPRISE', content: 'Nexus identified a coordinated 14% drop in critical rare-earth imports across three major ports, mapped against a surge in foreign export tariffs. Orion projects a supply chain bottleneck for tier-1 manufacturers within 14 days.' },
    { id: 3, title: 'Syndicate Network Mapped', date: '2024.11.18', category: 'INTELLIGENCE', content: 'Helix successfully aligned 12 disparate police databases, resolving 300+ aliases into a singular organized crime entity. The graph reveals direct financial links to three shell companies operating in the logistics sector.' },
    { id: 4, title: 'Infrastructure Stress Event', date: '2024.11.17', category: 'OPERATIONS', content: 'Aegis parsed maintenance logs across 40 power grid substations, highlighting a subtle degradation pattern in cooling units. Nexus graph indicates a single faulty batch from a third-party vendor. Preemptive replacement order generated.' },
    { id: 5, title: 'Phishing Campaign Neutralised', date: '2024.11.16', category: 'CYBER', content: 'Orion detected an emergent phishing syntax targeting government endpoints. Within 12 seconds, Aegis extracted the threat vector, and Helix automatically updated firewall schemas across all 15 active nodes.' },
    { id: 6, title: 'Crop Yield Projection Update', date: '2024.11.15', category: 'ECONOMICS', content: 'Fusing geospatial satellite imagery with regional fertilizer procurement data, Nexus has revised the Q4 wheat yield projection down by 2.4%. Strategic reserves have been notified to prevent market speculation.' },
  ];
