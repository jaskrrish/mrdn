      ...
      <div className="space-y-12 text-[#7A7A7A] font-sans leading-relaxed">
        ...
        <section>
          ...
          <p className="leading-loose">
            We do not build dashboards. We build a living, multi-layered reasoning engine. Orion ingests the data. Helix maps the government threat graph. Nexus maps the enterprise operations graph. Aegis makes every node queryable in any Indian language. We are collapsing the distance between raw data and decisive action.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="leading-loose">
            Palantir was built for the Pentagon. MRDN is built for India. Sovereign infrastructure. Indian data staying on Indian servers. Accessible to both the government defending the nation and the enterprises building its future.
          </p>
        </section>
